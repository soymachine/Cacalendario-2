          ...
          {user && pushPermission !== 'unsupported' && (
            <div className="rounded-2xl p-5 mb-4" style={{ backgroundColor: theme.glass }}>
              ...
              {!isStandalone ? (
                ...
                <>
                  <p className="text-xs mt-2 mb-3" style={{ color: `${theme.text}80` }}>
                    Las notificaciones están bloqueadas. Para activarlas en iOS:
                  </p>
                  <p className="text-xs mb-1 font-bold" style={{ color: `${theme.text}80` }}>
                    Ajustes del iPhone → busca "Fluxia" en la lista de apps → Notificaciones → Permitir notificaciones
                  </p>
                  <p className="text-xs mt-2 mb-3" style={{ color: `${theme.text}60` }}>
                    Si no aparece en la lista, elimina la app de la pantalla de inicio y reinstálala desde Safari.
                  </p>
                  <button
